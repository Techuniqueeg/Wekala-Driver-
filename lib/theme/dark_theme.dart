...
ThemeData dark = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFF032F5E),
  ...
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(foregroundColor: const Color(0xFF032F5E)),
  ),
  colorScheme: const ColorScheme.dark(
    primary: Color(0xFF032F5E),
    secondary: Color(0xFF032F5E),
