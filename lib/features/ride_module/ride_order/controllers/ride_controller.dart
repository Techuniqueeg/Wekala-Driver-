...
import 'package:wekala_delivery/features/ride_module/ride_order/domain/models/pending_ride_request_model.dart';
...
class RideController extends GetxController implements GetxService {
  ...
  PendingRideRequestModel? get pendingRideRequestModel =>
      _pendingRideRequestModel;
