...
class EditWithdrawMethodScreen extends StatefulWidget {
  ...
  @override
  State<EditWithdrawMethodScreen> createState() =>
      _EditWithdrawMethodScreenState();
}
                            ...
                            Container(
                              ...
                              child: CustomDropdown<int>(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    disbursementController.widthDrawMethods !=
                                                null &&
                                            disbursementController
                                                .widthDrawMethods!
                                                .isNotEmpty
                                        ? disbursementController
                                              .widthDrawMethods![disbursementController
                                                  .selectedMethodIndex!]
                                              .methodName!
                                  ...
                                  children: [
                                    Expanded(
                                      child: CustomTextFieldWidget(
                                        labelText: disbursementController
                                            .methodFields[index]
                                            .inputName
                                            .toString()
                                            .replaceAll('_', ' ')
                ...
                child: CustomButtonWidget(
                  ...
                  onPressed: () {
                    ...
                    if (fieldEmpty) {
                      ...
                      data['disbursement_withdrawal_method_id'] = widget
                          .method
                          .id
                          .toString();
                      ...
                      disbursementController.addWithdrawMethod(
                        data,
                        isUpdate: true,
                      );
                    }
