                  ...
                  child: Column(
                    children: [
                      CustomDropdownButton(
                        ...
                        dropdownMenuItems: myAccountController.earningTypes
                            .map(
                      ...
                      CustomDropdownButton(
                        ...
                        dropdownMenuItems: myAccountController.dateTypes
                            .map(
                      ...
                      Visibility(
                        visible:
                            myAccountController.selectedDateType ==
                            'custom_date_range',
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              myAccountController.from != null &&
                                      myAccountController.to != null
                                  ? Text(
                                      '${myAccountController.from} - ${myAccountController.to}',
                                      style: robotoRegular,
                                    )
                                  : Text(
                    ...
                    Expanded(
                      child: CustomButtonWidget(
                        ...
                        backgroundColor: Theme.of(
                          context,
                        ).disabledColor.withValues(alpha: 0.25),
