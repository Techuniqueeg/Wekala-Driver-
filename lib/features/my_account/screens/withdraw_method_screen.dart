...
import 'package:wekala_delivery/common/widgets/custom_loader.dart';
...
import 'package:wekala_delivery/features/my_account/widgets/confirm_dialog_widget.dart';
...
class _WithdrawMethodScreenState extends State<WithdrawMethodScreen> {
  ...
  Future<void> initCall() async {
    ...
    disbursementHelper.enableDisbursementWarningMessage(
      false,
      ...
      builder: (disbursementController) {
        return Scaffold(
          ...
          floatingActionButton:
              disbursementController.disbursementMethodBody != null &&
          ...
          body: disbursementController.disbursementMethodBody != null
              ? disbursementController
                        .disbursementMethodBody!
                        .methods!
                        .isNotEmpty
                                            ...
                                            children: [
                                              ...
                                              PopupMenuButton(
                                                ...
                                                onSelected: (value) async {
                                                  if (value == 'edit') {
                                                    Get.toNamed(
                                                      RouteHelper.getEditWithdrawMethodRoute(
                                                        method: method,
                                                      ),
                                                    );
                                                  } else if (value ==
