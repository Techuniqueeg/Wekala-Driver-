...
import 'package:wekala_delivery/common/widgets/filter_bottom_sheet_widget.dart';
...
import 'package:wekala_delivery/features/my_account/widgets/reports/loyalty_view_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/reports/order_view_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/reports/refer_view_widget.dart';
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        if (Get.find<MyAccountController>().offset < pageSize) {
          Get.find<MyAccountController>().setOffset(
            Get.find<MyAccountController>().offset + 1,
          );
                ...
                InkWell(
                  onTap: () {
                    myAccountController.downloadEarningInvoice(
                      ...
                      earningType: _selectedTabIndex == 0
                          ? null
                          : _selectedTabIndex == 1
                          ? 'referral_earning'
                          : 'loyalty_earning',
                  ...
                  child: Container(
                    ...
                    child: !myAccountController.downloadLoading!
                        ? Icon(
                            Icons.download,
                            size: 20,
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              ...
                              _earningCard(
                                context: context,
                                image: Images.deliveryFeeEarned,
                                price:
                                    myAccountController
                                        .earningReportModel
                                        ?.totalDeliveryCharge ??
                              ...
                              _earningCard(
                                context: context,
                                image: Images.deliveryTipsEarned,
                                price:
                                    myAccountController
                                        .earningReportModel
                                        ?.totalDmTips ??
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${myAccountController.pageSize ?? 0} ${'result_found'.tr}',
                            style: robotoRegular.copyWith(
                              fontSize: Dimensions.fontSizeLarge,
                              color: Theme.of(context).hintColor,
                            ),
