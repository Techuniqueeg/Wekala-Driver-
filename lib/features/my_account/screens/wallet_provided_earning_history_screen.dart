    ...
    return Scaffold(
      ...
      body: GetBuilder<MyAccountController>(
        builder: (myAccountController) {
          return myAccountController.walletProvidedTransactions != null
              ? myAccountController.walletProvidedTransactions!.isNotEmpty
                    ? ListView.builder(
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${'wallet'.tr} ${myAccountController.walletProvidedTransactions![index].method?.replaceAll('_', ' ').capitalize ?? ''}',
