        ...
        children: [
          ...
          Text(
            PriceConverterHelper.convertPrice(
              loyalityPoints?.convertedAmount ?? 0,
            ),
            style: robotoBold.copyWith(
          ...
          RichText(
            ...
            text: TextSpan(
              children: [
                ...
                TextSpan(
                  text: loyalityPoints?.transactionId ?? '',
                  style: robotoBold.copyWith(
          ...
          Text(
            DateConverterHelper.utcToDateTime(loyalityPoints!.createdAt!),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            '${loyalityPoints?.point ?? 0} ${'point'.tr}',
                            style: robotoBold.copyWith(
