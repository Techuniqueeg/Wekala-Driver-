...
import 'package:wekala_delivery/features/my_account/widgets/account/point_filter_bottom_sheet_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/account/point_to_wallet_money_widget.dart';
...
class _MyPointViewState extends State<MyPointView> {
  ...
  void initState() {
    ...
    Get.find<MyAccountController>().getLoyaltyPointList(
      ...
      transactionType:
          Get.find<MyAccountController>().selectedTransactionType ?? 'both',
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    bool loyaltyPointStatus = isRideActive
        ? (config!.riderLoyalityPointData?.loyalityPointStatus ?? false)
        : ((config!.dmLoyalityPointData?.loyalityPointStatus ?? false));

    if (!loyaltyPointStatus) {
      return Expanded(
        child: emptyView('your_loyalty_points_are_safe'.tr, context),
      );
    }
    return Expanded(
          ...
          builder: (profileController) {
            return GetBuilder<MyAccountController>(
              builder: (myAccountController) {
                if (myAccountController.loyaltyPointModel == null ||
                    myAccountController.isLoading) {
                  return Padding(
                    padding: const EdgeInsets.only(top: 250),
                    child: const Center(child: CircularProgressIndicator()),
                  );
                } else if (!myAccountController.isFiltered &&
                    myAccountController.loyaltyPointModel!.loyalityPoints !=
                        null &&
                    myAccountController
                        .loyaltyPointModel!
                        .loyalityPoints!
                        .isEmpty) {
                  return emptyView(
                    'our_loyalty_program_is_temporary_paused'.tr,
                    context,
                  );
                }
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'convert_loyalty_point_to_wallet_money_once_you_have_enough_balance'
                                  .tr,
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      '${profileController.profileModel?.loyaltyPoint ?? "0"}',
                                      style: robotoBold.copyWith(
                                    ...
                                    onTap: () {
                                      ...
                                      if (loyaltyPointStatus) {
                                        showDialog(
                                          ...
                                          context: context,
                                          builder: (_) =>
                                              PointToWalletMoneyWidget(
                                                isRideActive: isRideActive,
                                              ),
                                        );
                                      } else {
                                        showCustomSnackBar(
                                          'point_conversion_is_currently_unavailable'
                                              .tr,
                                        );
                                      }
                                    },
                                ...
                                Get.bottomSheet(
                                  PointFilterBottomSheetWidget(
                                    ...
                                    onApply: (dateRange, startDate, endDate) async {
                                      if (startDate != null &&
                                          endDate != null) {
                                        await myAccountController.setDateRange(
                                          from: startDate,
                                          to: endDate,
                                        );
                                      }
                                      if (dateRange != null) {
                                        myAccountController.setDateType(
                                          dateRange,
                                        );
                      ...
                      myAccountController.loyaltyPointModel != null
                          ? (myAccountController
                                        .loyaltyPointModel
                                        ?.loyalityPoints
                                        ?.isNotEmpty ??
                                ...
                                ? PaginatedListViewWidget(
                                    ...
                                    productView: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        var point = myAccountController
                                            .loyaltyPointModel
                                            ?.loyalityPoints?[index];
                                        bool isCredit = point?.type == 'credit';
                                        bool isOrder =
                                            point?.transactionType ==
                                            'earn_on_order_completion';
                                                  ...
                                                  Flexible(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          DateConverterHelper.formatUtcTime(
                                                            point!.createdAt!,
                                                          ),
                                                          style: robotoRegular
                                                              .copyWith(
                                ...
                                : SizedBox(
                                    ...
                                    child: Center(
                                      child: Text('no_point_history_found'.tr),
                                    ),
                                  )
                          : SizedBox(
                              height: Get.height * 0.3,
