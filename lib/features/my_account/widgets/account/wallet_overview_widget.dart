...
import 'package:wekala_delivery/features/my_account/widgets/amount_card_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/empty_state_bottom_sheet.dart';
import 'package:wekala_delivery/features/my_account/widgets/payment_method_bottom_sheet_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/tab_section_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/transaction_section_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/wallet_attention_alert_widget.dart';
import 'package:wekala_delivery/features/my_account/widgets/withdrawal_bottomsheet.dart';
          ...
          return GetBuilder<ProfileController>(
            builder: (profileController) {
              bool isPayable =
                  ...
                  profileController.profileModel!.showPayNowButton == true;
              bool isAdjust =
                  profileController.profileModel != null &&
                  profileController.profileModel!.adjustable == true;

              return (profileController.profileModel != null &&
                      myAccountController.transactions != null)
                  ? Padding(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                children: [
                                      ...
                                      : Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                isPayable
                                                    ? 'you_can_pay_the_amount_to_the_admin'
                                                          .tr
                                                    : 'you_can_send_withdraw_request_to_admin'
                                                          .tr,
                                                        ...
                                                        ? InkWell(
                                                            onTap: () {
                                                              ...
                                                              minimumPayableAmount =
                                                                  isRideActive
                                                                  ? (config?.minAmountToPayRider ??
                                                                        0)
                                                                  : (config?.minAmountToPayDm ??
                                                                        0);
                                  ...
                                  TabSectionWidget(
                                    selectedIndex:
                                        myAccountController.selectedIndex,
                                    onTabChanged: (index) {
                                      if (myAccountController.selectedIndex !=
                                          index) {
                                  ...
                                  myAccountController.selectedIndex == 0
