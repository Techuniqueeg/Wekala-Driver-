...
class PointFilterBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<PointFilterBottomSheetWidget> createState() =>
      _PointFilterBottomSheetWidgetState();
}

class _PointFilterBottomSheetWidgetState
    extends State<PointFilterBottomSheetWidget> {
  ...
  final List<String> _transactionTypeOptions = ['both', 'debit', 'credit'];
                ...
                child: Column(
                  ...
                  children: [
                    CustomDropdownButton(
                      ...
                      dropdownMenuItems: _transactionTypeOptions
                          .map(
                      ...
                      selectedValue:
                          myAccountController.selectedTransactionType,
                    ),
                    const SizedBox(height: Dimensions.paddingSizeLarge),
