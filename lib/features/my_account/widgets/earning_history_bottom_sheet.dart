...
class EarningHistoryBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final orderWiseTotalEarning =
        (data?.dmTips ?? 0) + (data?.originalDeliveryCharge ?? 0);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            PriceConverterHelper.convertPrice(orderWiseTotalEarning),
            style: robotoBold.copyWith(
          ...
          Text(
            DateConverterHelper.utcToDateTime(data!.createAt!),
            style: robotoRegular.copyWith(color: Theme.of(context).hintColor),
          ),

          Text(
            '${'pay_by'.tr}: ${data?.order?.paymentMethod?.tr}'.replaceAll(
              '_',
              ' ',
            ),
            style: robotoRegular.copyWith(color: Theme.of(context).hintColor),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            PriceConverterHelper.convertPrice(deliveryFee),
                            style: robotoRegular.copyWith(
                              color: Theme.of(context).hintColor,
                              fontSize: Dimensions.fontSizeLarge,
                            ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            PriceConverterHelper.convertPrice(deliveryTip),
                            style: robotoRegular.copyWith(
                              color: Theme.of(context).hintColor,
                              fontSize: Dimensions.fontSizeLarge,
                            ),
