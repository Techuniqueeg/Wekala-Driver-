...
import 'package:wekala_delivery/features/my_account/widgets/earning_history_bottom_sheet.dart';
import 'package:wekala_delivery/features/my_account/widgets/loyalty_history_bottom_sheet.dart';
import 'package:wekala_delivery/features/my_account/widgets/referral_history_bottom_sheet.dart';
      ...
      onTap: () {
        if (earning != null) {
          showCustomBottomSheet(
            child: EarningHistoryBottomSheet(data: earning),
          );
        } else if (refrealEarnings != null) {
          showCustomBottomSheet(
            child: ReferralHistoryBottomSheet(refrealEarnings: refrealEarnings),
          );
        } else if (loyalityPoints != null) {
          showCustomBottomSheet(
            child: LoyaltyHistoryBottomSheet(loyalityPoints: loyalityPoints),
          );
        }
      },
      child: Column(
        children: [
          Container(
            margin: EdgeInsets.only(
              bottom: index == myAccountController.earningList!.length - 1
                  ? 0
            ...
            child: Row(
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (earning != null && earning!.order?.id != null) ...[
                        ...
                        Text(
                          '${'transaction_id'.tr} #${refrealEarnings!.transactionId}',
                          maxLines: 1,
                        ...
                        Text(
                          '${'transaction_id'.tr} #${loyalityPoints!.transactionId}',
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: robotoRegular.copyWith(
                            color: Theme.of(context).textTheme.bodyLarge!.color!
                        ...
                        Text(
                          loyalityPoints!.transactionType!.tr,
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: robotoRegular.copyWith(
                            color: Theme.of(context).textTheme.bodyLarge!.color!
                ...
                Column(
                  ...
                  children: [
                    Text(
                      DateConverterHelper.utcToDateTime(createdAt),
                      style: robotoRegular.copyWith(
                        color: Theme.of(context).disabledColor,
                      ),
                    ),
