...
class ReferViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return myAccountController.referralEarningsList != null
        ? myAccountController.referralEarningsList!.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return EarningReportCard(
                      ...
                      earning: null,
                      refrealEarnings:
                          myAccountController.referralEarningsList![index],
                      loyalityPoints: null,
                      createdAt: myAccountController
                          .referralEarningsList![index]
                          .createdAt!,
                      showDivider:
                          index !=
                          myAccountController.referralEarningsList!.length - 1,
                    );
                  },
                )
              : Center(
