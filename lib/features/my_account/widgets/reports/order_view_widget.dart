...
class OrderViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return myAccountController.earningList != null
        ? myAccountController.earningList!.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return EarningReportCard(
                      ...
                      loyalityPoints: null,
                      createdAt:
                          myAccountController.earningList![index].createAt!,
                      showDivider:
                          index != myAccountController.earningList!.length - 1,
                    );
                  },
                )
              : Center(
