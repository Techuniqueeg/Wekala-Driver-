    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            PriceConverterHelper.convertPrice(refrealEarnings?.amount ?? 0),
            style: robotoBold.copyWith(
          ...
          RichText(
            ...
            text: TextSpan(
              children: [
                ...
                TextSpan(
                  text: refrealEarnings?.transactionId ?? '',
                  style: robotoBold.copyWith(
          ...
          Text(
            DateConverterHelper.utcToDateTime(refrealEarnings!.createdAt!),
