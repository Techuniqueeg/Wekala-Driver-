...
class _NewPassScreenState extends State<NewPassScreen> {
                      ...
                      children: [
                        ...
                        widget.fromPasswordChange
                            ...
                            : Column(
                                ...
                                children: [
                                  Text(
                                    'number_verification_is_successful'.tr,
                                  ...
                                  Text(
                                    'please_set_your_new_password'.tr,
                                    style: robotoRegular.copyWith(
                                      color: Theme.of(context)
                                          .textTheme
                                          .bodyLarge
  ...
  void _resetPassword(AuthController authController) {
    ...
    String type = AppConstants.appMode == AppMode.delivery
            ...
            .then((value) {
              if (value.isSuccess) {
                Get.find<AuthController>()
                    .login('+${widget.number!.trim()}', password, type)
                    .then((value) async {
