...
import 'package:wekala_delivery/features/earning_reports/widgets/earning_card_widget.dart';
import 'package:wekala_delivery/features/earning_reports/widgets/transaction_card_widget.dart';
...
class _EarningReportScreenState extends State<EarningReportScreen> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
          ...
          Get.find<EarningReportController>().transactions != null &&
          !Get.find<EarningReportController>().isLoading) {
        int pageSize = (Get.find<EarningReportController>().pageSize! / 10)
            .ceil();
  ...
  Widget build(BuildContext context) {
    return GetBuilder<EarningReportController>(
              ...
              itemBuilder: (context) {
                return <PopupMenuEntry<FilterType>>[
                  PopupMenuItem<FilterType>(
                    ...
                    child: SizedBox(
                      width: 100,
                      child: Text('all_the_time'.tr, style: robotoRegular),
                    ),
                  ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        reportController.transactions == null
                            ...
                            : ListView.builder(
                                itemCount:
                                    reportController.transactions!.length,
                                physics: const NeverScrollableScrollPhysics(),
                                shrinkWrap: true,
                                itemBuilder: (context, index) {
                                  final txn =
                                      reportController.transactions![index];
                                  ...
                                  return Padding(
                                    ...
                                    child: OrderCard(
                                      ...
                                      dateTime:
                                          DateConverterHelper.isoStringToLocalDateTime(
                                            txn.date!,
                                          ),
                                      rows: [
