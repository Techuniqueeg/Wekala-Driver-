...
class ReferEarnRepository implements ReferEarnRepositoryInterface {
  ...
  @override
  Future<Response> getEarningHistoryList(
    int offset,
    String type,
    String? startDate,
    String? endDate,
    ...
    return await apiClient.getData(
      '${AppConstants.referralEarningList}?limit=10&offset=$offset&date_range=$type&start_date=${startDate ?? ''}&end_date=${endDate ?? ''}&token=${_getUserToken()}',
    );
  }
