...
import 'package:wekala_delivery/features/refer_and_earn/widgets/referral_details.dart';
import 'package:wekala_delivery/features/refer_and_earn/widgets/referral_earning.dart';
...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen> {
  List<String> types = ['referral_details', 'earning'];
  int selectedIndex = 0;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          selectedIndex == 0
              ? const ReferralDetails(status: false)
