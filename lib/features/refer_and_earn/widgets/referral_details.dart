...
import 'package:wekala_delivery/features/refer_and_earn/widgets/referral_earn_bottomsheet_widget.dart';
...
class ReferralDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double referralAmount = isRideActive
        ? (config?.riderReferralData?.referalAmount ?? 0)
        : (config?.dmReferralData?.referalAmount ?? 0);

    return Expanded(
      child: GetBuilder<ReferAndEarnController>(
        builder: (referAndEarnController) {
          var config = Get.find<SplashController>().configModel;
          bool referralStatus = isRideActive
          ...
          return referralStatus
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text:
                                    '  ${PriceConverterHelper.convertPrice(referralAmount)}  ',
                                style: robotoBold,
                              ),
                              TextSpan(
              ...
              : Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(
                        horizontal: Dimensions.paddingSizeExtraLarge * 1.5,
                      ),
                      child: Text(
