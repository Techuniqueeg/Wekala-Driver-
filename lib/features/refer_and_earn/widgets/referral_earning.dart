...
import 'package:wekala_delivery/features/refer_and_earn/widgets/earning_card_widget.dart';
            ...
            builder: (referAndEarnController) {
              return Column(
                children: [
                            ...
                            Get.bottomSheet(
                              FilterBottomSheetWidget(
                                ...
                                onApply: (dateRange, startDate, endDate) {
                                  referAndEarnController.setDateRange(
                                    dateRange!,
                                    startDate: startDate,
                                    endDate: endDate,
                                  );
                                  referAndEarnController.getEarningHistoryList(
                                    1,
                                  );
                                },
                                onReset: () {
                  ...
                  (referAndEarnController.referralModel?.refrealEarnings !=
                              null &&
                          !referAndEarnController.isLoading)
                            ...
                            ? Expanded(
                                child: SingleChildScrollView(
                                  ...
                                  child: PaginatedListViewWidget(
                                    scrollController:
                                        referAndEarnController.scrollController,
                                    totalSize: referAndEarnController
                                        .referralModel!
                                        .total,
                                    offset:
                                        (referAndEarnController
