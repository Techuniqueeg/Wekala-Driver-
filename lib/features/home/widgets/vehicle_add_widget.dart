...
import 'package:wekala_delivery/features/ride_module/add_vehicle/screens/add_vehicle_screen.dart';
...
class VehicleAddWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return vehicle == null || vehicle?.vehicleRequestStatus == "pending"
        ? Container(
            ...
            child: vehicle?.vehicleRequestStatus == "pending"
                ? Row(
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'after_approval_vehicle_information'.tr,
