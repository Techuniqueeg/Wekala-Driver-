...
import 'package:wekala_delivery/common/widgets/order_widget.dart';
            ...
            children: [
              ...
              hasActiveOrder
                  ? TitleWidget(
                      ...
                      showOrderCount: true,
                      orderCount: orderController.currentOrderList?.length ?? 0,
                      onTap: hasMoreOrder
                          ? () {
                  ...
                  : const SizedBox(),
              SizedBox(
                height: hasActiveOrder ? Dimensions.paddingSizeExtraSmall : 0,
              ),
              ...
              orderController.currentOrderList == null
                  ...
                  : const SizedBox(),
              SizedBox(
                height: hasActiveOrder ? Dimensions.paddingSizeDefault : 0,
              ),
            ],
          ),
        );
