    ...
    return GetBuilder<RideController>(
      builder: (rideController) {
        ...
        if (rideController.lastRideDetails != null &&
          ...
          tripDate = DateConverterHelper.dateTimeStringToDateOnly(
        ...
        return rideController.lastRideDetails != null &&
                rideController.lastRideDetails!.isNotEmpty &&
                rideController.lastRideDetails![0].currentStatus !=
                    'completed' &&
                rideController.lastRideDetails![0].currentStatus != 'cancelled'
            ? InkWell(
                onTap: () => RideHelper.navigateToNextScreen(
                  id: rideController.lastRideDetails![0].id,
                ),
                child: Container(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () => RideHelper.navigateToNextScreen(
                              id: rideController.lastRideDetails![0].id,
                            ),
                      ...
                      Row(
                        children: [
                          Text(
                            '${'ride_id'.tr} # ${rideController.lastRideDetails?[0].refId}',
                          ...
                          Text(
                            DateConverterHelper.dateTimeStringToMonthAndYear(
                              rideController.lastRideDetails![0].createdAt!,
                            ),
                            style: robotoMedium.copyWith(
                              color: Theme.of(context).disabledColor,
                      ...
                      Text(
                        '${'est_drop_off_time'.tr} - ${rideController.lastRideDetails![0].estimatedTime} min',
                        style: robotoBold.copyWith(
                          color: Theme.of(context).disabledColor,
                        ),
                      ),
