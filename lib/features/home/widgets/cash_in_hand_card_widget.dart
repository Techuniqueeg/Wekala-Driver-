          ...
          RichText(
            text: TextSpan(
              children: [
                ...
                if ((profileController.profileModel!.dmMaxMyAccount != null) &&
                    (profileController.profileModel!.dmMaxMyAccount! > 0) &&
                    (profileController.profileModel!.cashInHands! >
                        profileController.profileModel!.dmMaxMyAccount!))
                  TextSpan(
                    text: ' (${'limit_exceeded'.tr})',
                    style: robotoRegular.copyWith(
