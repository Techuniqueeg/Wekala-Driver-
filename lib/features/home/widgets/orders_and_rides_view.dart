...
class OrdersAndRidesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isActiveBothDeliveryAndRide =
        (profileController.profileModel?.isDeliveryOn ?? false) &&
        (profileController.profileModel?.isRideOn ?? false);
    double width = isActiveBothDeliveryAndRide
        ? Get.width - 90
