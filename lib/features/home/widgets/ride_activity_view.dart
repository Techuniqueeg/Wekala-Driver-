...
import 'package:wekala_delivery/common/widgets/title_widget.dart';
    ...
    return GetBuilder<ProfileController>(
      builder: (profileController) {
        ...
        if (profileController.profileModel != null &&
            profileController.profileModel!.timeTrack != null) {
          activeSec = profileController.profileModel!.timeTrack!.totalOnline!
              .floor();
          drivingSec = profileController.profileModel!.timeTrack!.totalDriving!
              .floor();
          idleSec = profileController.profileModel!.timeTrack!.totalIdle!
              .floor();
          offlineSec = profileController.profileModel!.timeTrack!.totalOffline!
              .floor();
        }
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          formatMinutes(activityList[index].value),
