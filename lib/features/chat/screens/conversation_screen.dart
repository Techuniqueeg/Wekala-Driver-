...
import 'package:wekala_delivery/common/widgets/custom_ink_well_widget.dart';
...
import 'package:wekala_delivery/features/chat/widgets/search_field_widget.dart';
...
class _ConversationScreenState extends State<ConversationScreen>
  ...
  void _decideTabFromSearchResult(ConversationsModel? conversation) {
    ...
    if (conversation != null &&
      ...
      if (conversation.conversations!.first.senderType ==
    ...
    } else if (type == AppConstants.customer &&
            ...
            children: [
              ...
              Expanded(
                child: RefreshIndicator(
                  onRefresh: () async {
                    await chatController.getConversationList(
                      1,
                      type: chatController.type,
                    );
                  },
      ...
      child: PaginatedListViewWidget(
        ...
        productView: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            bool unSeen =
                conversation.lastMessage?.isSeen == 0 &&
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: unSeen
                        ? Theme.of(context).hintColor.withValues(alpha: 0.01)
                        : Theme.of(
                            context,
                    ...
                    Get.toNamed(
                      RouteHelper.getChatRoute(
                        notificationBody: NotificationBodyModel(
                          ...
                          customerId: type == AppConstants.customer
                              ? user.userId
                              : null,
                          vendorId: type == AppConstants.vendor
                              ? user.vendorId
                              : null,
                        ),
                      ...
                      (value) => Get.find<ChatController>().getConversationList(
                        1,
                        type: chatController.type,
                      ),
                    );
...
enum UserType { user, customer, admin, vendor }
