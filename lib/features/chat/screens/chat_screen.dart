...
import 'package:wekala_delivery/features/chat/widgets/message_bubble_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(
      builder: (chatController) {
        ...
        bool showFaq =
            chatController.showFaqQuestions &&
            chatController.messageModel != null &&
            Get.find<SplashController>().configModel!.riderFaqs != null &&
            Get.find<SplashController>().configModel!.riderFaqs!.isNotEmpty;
                                                      ...
                                                      return MessageBubbleWidget(
                                                        ...
                                                        userType:
                                                            widget
                                                                ...
                                                                null
                                                            ? AppConstants.admin
                                                            : widget.notificationBody!.customerId !=
                                                                      null ||
                                                                  (widget.notificationBody!.conversationId !=
                                                                          null &&
                                                                      widget.notificationBody!.type ==
                                                                          'user')
                                                            ? AppConstants.user
                                                            : AppConstants
                                                                  .vendor,
                                    ...
                                    ? Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child: ClipRRect(
                                                                            ...
                                                                            child:
                                                                                ...
                                                                                ? Image.network(
                                                                                    chatController.chatImage![index].path,
                                                                                    width: 100,
                                                                                    height: 100,
                                                                                    fit: BoxFit.cover,
                                                                                  )
                                            ...
                                            // Video Preview
                                            (chatController.pickedVideoFile !=
                                                        null ||
                                                    chatController
                                                            .pickedWebVideoFile !=
                                                        null)
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                chatController
                                                                            ...
                                                                            .length >
                                                                        15
                                                                    ? '${chatController.pickedVideoFile!.name.substring(0, 15)}...'
                                                                    : chatController
                                                                          .pickedVideoFile!
                                                                          .name,
                                                                style: robotoMedium
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      if (chatController
                                                                              ...
                                                                              .isNotEmpty &&
                                                                          index <
                                                                              chatController.fileSizeList.length)
                                                                        Text(
