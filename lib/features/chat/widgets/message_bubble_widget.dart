...
import 'package:wekala_delivery/features/chat/widgets/image_diaglog_widget.dart';
...
class MessageBubbleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String previousMessageHasChatTime = previousMessage != null
        ...
        : "";
    bool isSameUserWithPreviousMessage = _isSameUserWithPreviousMessage(
      previousMessage,
      message,
    );
    bool isSameUserWithNextMessage = _isSameUserWithNextMessage(
      message,
      nextMessage,
    );
    ...
    if (userType == AppConstants.admin) {
      isReply =
          message.senderId !=
          Get.find<ProfileController>().profileModel!.userinfo!.id;
    }
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    (isReply && !isSameUserWithPreviousMessage) ||
                            ((isReply && isSameUserWithPreviousMessage) &&
                                chatController
                        ...
                        : isReply
                        ? const SizedBox(
                            width: Dimensions.paddingSizeExtraLarge + 15,
                          )
                        : const SizedBox(),
