...
import 'package:wekala_delivery/common/widgets/custom_confirmation_bottom_sheet.dart';
...
import 'package:wekala_delivery/features/language/widgets/language_bottom_sheet_widget.dart';
...
import 'package:wekala_delivery/features/profile/widgets/notification_status_change_bottom_sheet.dart';
import 'package:wekala_delivery/features/profile/widgets/profile_level_details_widget.dart';
import 'package:wekala_delivery/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:wekala_delivery/features/ride_module/add_vehicle/screens/vehicle_details_screen.dart';
import 'package:wekala_delivery/features/ride_module/help_and_support/screens/help_and_support_screen.dart';
import 'package:wekala_delivery/features/ride_module/leaderboard/screens/leaderboard_screen.dart';
...
import 'package:wekala_delivery/features/ride_module/safety/screen/safety_policy_screen.dart';
...
import 'package:wekala_delivery/common/widgets/custom_image_widget.dart';
import 'package:wekala_delivery/features/profile/widgets/profile_bg_widget.dart';
import 'package:wekala_delivery/features/profile/widgets/profile_button_widget.dart';
import 'package:wekala_delivery/features/profile/widgets/profile_card_widget.dart';
                  ...
                  circularImage: Container(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        if (isRideActive && config?.riderLevelStatus == 1)
                          Positioned(
                            bottom: -5,
                            child: InkWell(
                              onTap: () {
                                Get.find<ProfileController>()
                                    .getProfileLevelInfo();
                                Get.bottomSheet(
                                  const ProfileLevelDetailsWidget(),
                                );
                              },
                              child: Container(
                          ...
                          children: [
                            ...
                            if (isRideActive)
                              Row(
                                ...
                                children: [
                                  Text(
                                    '${profileController.profileModel!.avgRating.toString()} ',
                                  ),
                                  ...
                                  Text(
                                    '(${'reviews'.tr} ${profileController.profileModel?.ratingCount})',
                                    style: robotoRegular.copyWith(
                                      color: Theme.of(
                                        context,
                                        ...
                                        builder: (rideController) {
                                          return GetBuilder<OrderController>(
                                            builder: (orderController) {
                                              bool isRideActive =
                                                  AppConstants.appMode ==
                                                  AppMode.ride;
                                              bool haveRunningRide =
                                                  rideController
                                                          .lastRideDetails !=
                                                      null &&
                                                  rideController
                                                              ...
                                                              child: CustomConfirmationBottomSheet(
                                                                title:
                                                                    'you_cant_go_offline'
                                                                        .tr,
                                                                description:
                                                                    'you_can_not_go_offline_now_for_ride'
                                                                        .tr,
                                                                buttonWidget: Padding(
                                                                  padding:
                                                                      const EdgeInsets.only(
                            ...
                            if (profileController.profileModel?.vehicle !=
                                    null &&
                                isRideActive)
                              Padding(
                                padding: const EdgeInsets.only(
                            ...
                            (profileController.profileModel != null &&
                                ...
                                ? Padding(
                                    ...
                                    child: ProfileButtonWidget(
                                      ...
                                      onTap: () {
                                        Get.toNamed(
                                          RouteHelper.getEarningReportRoute(),
                                        );
                                      },
                                    ),
                                  )
