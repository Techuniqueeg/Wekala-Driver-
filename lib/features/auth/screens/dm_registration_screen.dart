...
import 'package:wekala_delivery/common/widgets/custom_card.dart';
...
import 'package:wekala_delivery/helper/custom_validator_helper.dart';
...
import 'package:wekala_delivery/common/widgets/custom_text_field_widget.dart';
import 'package:wekala_delivery/features/auth/widgets/pass_view_widget.dart';
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          height: 4,
                          color: authController.dmStatus == 0.4
                              ? Theme.of(
                                  context,
          ...
          builder: (authController) {
            return GetBuilder<AddressController>(
              builder: (addressController) {
                ...
                bool isRiderReferralActive =
                    config?.riderReferralData?.referalStatus ?? false;
                bool isDmReferralActive =
                                                  ...
                                                  CustomDropdownButton(
                                                    hintText:
                                                        'select_delivery_zone'
                                                            .tr,
                                                    dropdownMenuItems: addressController
                                                        .zoneList!
                                                        .map(
                                                          (
                                                            zone,
                                                        ...
                                                        .toList(),
                                                    selectedValue: addressController
                                                ...
                                                children: [
                                                  CustomDropdownButton(
                                                    hintText:
                                                        'select_vehicle_type'
                                                            .tr,
                                                    dropdownMenuItems: authController
                                                        .vehicles!
                                                        .map(
                                                          (
                                                            vehicle,
                                        ...
                                        CustomTextFieldWidget(
                                          ...
                                          labelText:
                                              authController
                                                      .selectedIdentityType !=
                                                  null
                                              ? '${authController.selectedIdentityType?.tr} ${'number'.tr}'
                                              : 'identity_number'.tr,
                        ...
                        onPressed: !authController.acceptTerms
                            ...
                            : () async {
                                ...
                                String password = _passwordController.text
                                    .trim();
                                String confirmPass = _confirmPasswordController
                                    .text
                                    .trim();
                                ...
                                if (authController.dmStatus == 0.4) {
                                  ...
                                  if (authController.selectedDmTypeId == null &&
                                  ...
                                  } else if (authController.selectedVehicleId ==
                                          null &&
                                      !isRideActive) {
                                    showCustomSnackBar(
                                    ...
                                    String earningType = isRideActive
                                        ? '1'
                                        : authController.selectedDmTypeId!;
                                    ...
                                    authController.registerDeliveryMan(
                                      DeliveryManBodyModel(
                                        ...
                                        identityType:
                                            authController.selectedIdentityType,
                                        earning: earningType,
                                        zoneId: addressController
                                            .selectedDeliveryZoneId,
                                        vehicleId:
                                            authController.selectedVehicleId,
