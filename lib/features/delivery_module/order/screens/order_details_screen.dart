...
import 'package:wekala_delivery/features/delivery_module/order/widgets/bottom_view/parcel_bottom_view.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/bottom_view/regular_order_bottom_view.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/info_card_widget.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/order_item_widget.dart';
...
import 'package:wekala_delivery/helper/responsive_helper.dart';
import 'package:wekala_delivery/helper/route_helper.dart';
import 'package:wekala_delivery/helper/string_extension.dart';
          ...
          child: GetBuilder<OrderController>(
            builder: (orderController) {
              ...
              if (order != null && orderController.orderDetailsModel != null) {
                ...
                deliveryFeeReductionAmount =
                    order.deliveryFeeReductionAmount ?? 0;
                                    ...
                                    ? Column(
                                        children: [
                                          Row(
                                            children: [
                                              Text(
                                                '${(controllerOrderModel.scheduled ?? false) ? 'schedule'.tr : "order_date".tr} ',
                                                style: robotoRegular,
                                              ),
                                              const Expanded(child: SizedBox()),
                                    ...
                                    children: [
                                      ...
                                      couponDiscount > 0
                                          ? Row(
                                              ...
                                              children: [
                                                Text(
                                                  order.benefitType == 'coupon'
                                                      ? 'pro_coupon_discount'.tr
                                                      : 'coupon_discount'.tr,
                                                  style: robotoRegular,
                                                ),
                                                Text(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            order.benefitType == 'delivery_fee'
                                                ? 'pro_delivery_fee'.tr
                                                : 'delivery_fee'.tr,
                                            style: robotoRegular,
                                          ),
                                      ...
                                      order.benefitType == 'discount' &&
                                          ...
                                          ? Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '(-) ${PriceConverterHelper.convertPrice(proDiscount)}',
                                                  style: robotoRegular,
                                                ),
                                              ],
                                            )
                                      ...
                                      (order.deliveryType != null &&
                                          ...
                                          ? Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${order.deliveryType == 'slightly_delay' ? '(-)' : '(+)'} ${PriceConverterHelper.convertPrice(order.deliveryTypeCharge)}',
                                                  style: robotoRegular,
                                                  textDirection:
                                                      TextDirection.ltr,
                                                ),
