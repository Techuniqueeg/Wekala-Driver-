import 'package:wekala_delivery/common/widgets/order_shimmer_widget.dart';
import 'package:wekala_delivery/common/widgets/sliver_delegate.dart';
import 'package:wekala_delivery/features/delivery_module/order/controllers/order_controller.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/selected_type_button.dart';
import 'package:wekala_delivery/util/dimensions.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/history_order_widget.dart';
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        if (Get.find<OrderController>().offset < pageSize) {
          Get.find<OrderController>().setOffset(
            Get.find<OrderController>().offset + 1,
          );
                                ...
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: orderController
                                        .filteredOrderCountList
                                        .length,
                                    itemBuilder: (context, index) {
                                      final status = orderController
                                          .filteredOrderCountList[index];
