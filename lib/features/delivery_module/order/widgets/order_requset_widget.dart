...
import 'package:wekala_delivery/features/delivery_module/order/screens/order_location_screen.dart';
...
class OrderRequestWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool showEarning = isRideActive
        ? (config?.showRiderEarning ?? false)
        : (config?.showDmEarning ?? false);
