...
import 'package:wekala_delivery/features/delivery_module/order/widgets/parcel_cancelation/time_picker_widget.dart';
...
class ParcelReturnDateTimeBottomSheet extends StatefulWidget {
  ...
  const ParcelReturnDateTimeBottomSheet({
    super.key,
    required this.orderId,
    required this.canceledDateTime,
  });

  @override
  State<ParcelReturnDateTimeBottomSheet> createState() =>
      _ParcelReturnDateTimeBottomSheetState();
}

class _ParcelReturnDateTimeBottomSheetState
    extends State<ParcelReturnDateTimeBottomSheet> {
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        Text(
          'please_select_a_suitable_return_date_and_estimated_delivery_time_for_your_parcel'
              .tr,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: 40,
                child: controller.availableDates.isEmpty
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.only(
                                right:
                                    index ==
                                        controller.availableDates.length - 1
                                    ? 0
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                decoration: BoxDecoration(
                                  color: controller.selectedPeriod == 'AM'
                                      ? Theme.of(context).primaryColor
                                      : Colors.transparent,
                                  borderRadius: BorderRadius.circular(
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                decoration: BoxDecoration(
                                  color: controller.selectedPeriod == 'PM'
                                      ? Theme.of(context).primaryColor
                                      : Colors.transparent,
                                  borderRadius: BorderRadius.circular(
                                    Dimensions.radiusSmall,
              ...
              child: CustomButtonWidget(
                ...
                onPressed: () {
                  if (controller.selectedDateTime != null) {
                    ...
                    } else if (selectedDateTime.isBefore(
                      DateTime.now().add(const Duration(minutes: 1)),
                    )) {
                      showCustomSnackBar(
                        'return_date_and_time_must_be_in_future'.tr,
                      );
                    } else {
                      controller
                          .addParcelReturnDate(
                            orderId: widget.orderId,
                            returnDate: selectedDateTime.toString(),
                          )
                          .then((value) {
