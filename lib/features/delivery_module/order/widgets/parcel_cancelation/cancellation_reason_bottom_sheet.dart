...
import 'package:wekala_delivery/features/delivery_module/order/widgets/parcel_cancelation/custom_check_box_widget.dart';
                  ...
                  children: [
                    ...
                    orderController.parcelCancellationReasons != null &&
                            orderController
                                ...
                                .isNotEmpty
                        ? Text(
                            'please_select_cancellation_reason'.tr,
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return CustomCheckBoxWidget(
                                        title: reason?.reason ?? '',
                                        value: orderController.isReasonSelected(
                                          reason?.reason ?? '',
                                        ),
                        ...
                        if ((orderController.selectedParcelCancelReason !=
                          ...
                          await orderController
                              .updateOrderStatus(
                                ...
                                reasons:
                                    orderController.selectedParcelCancelReason,
                              ...
                              .then((success) async {
                                if (success) {
                                  ...
                                  await orderController.getOrderWithId(
                                    widget.orderId,
                                  );
                                }
                              });
