                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: (orderModel.detailsCount ?? 0) > 0
                            ? Text(
                                ' (${orderModel.detailsCount} ${(orderModel.detailsCount ?? 0) > 1 ? 'items'.tr : "item".tr})',
                                style: robotoRegular.copyWith(
                                  fontSize: Dimensions.fontSizeSmall,
                                ),
                              )
                  ...
                  Row(
                    ...
                    children: [
                      parcel
                          ? Row(
                              children: [
                                orderModel.parcelCategory!.name == 'Gifts'
                                    ? Image.asset(Images.giftIcon, width: 16)
                                    : Icon(
                      ...
                      Container(
                        ...
                        child: Text(
                          orderModel.moduleType == 'parcel'
                              ? 'parcel'.tr
                              : orderModel.moduleType == 'food'
                              ? 'food'.tr
                              : orderModel.moduleType == 'grocery'
                              ? 'grocery'.tr
                              : orderModel.moduleType == 'pharmacy'
                              ? 'pharmacy'.tr
