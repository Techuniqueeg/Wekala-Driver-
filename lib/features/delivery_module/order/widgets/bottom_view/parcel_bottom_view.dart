import 'package:wekala_delivery/common/widgets/custom_bottom_sheet_widget.dart';
import 'package:wekala_delivery/common/widgets/slider_button_widget.dart';
...
import 'package:wekala_delivery/features/delivery_module/order/widgets/bottom_view/delivery_confirmation_section.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/parcel_cancelation/cancellation_reason_bottom_sheet.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/parcel_cancelation/collect_money_bottom_sheet.dart';
import 'package:wekala_delivery/features/delivery_module/order/widgets/parcel_cancelation/parcel_return_date_time_bottom_sheet.dart';
...
import 'package:wekala_delivery/common/widgets/confirmation_dialog_widget.dart';
...
import 'package:wekala_delivery/features/delivery_module/order/widgets/verify_delivery_sheet_widget.dart';
...
class ParcelBottomView extends StatelessWidget {
  ...
  final int orderId;
  final double? total;
  const ParcelBottomView({
    super.key,
    required this.orderController,
    required this.controllerOrderModel,
    required this.fromLocationScreen,
    required this.showDeliveryConfirmImage,
  ...
  Widget build(BuildContext context) {
    final bool isShowableStatus = [
      'accepted',
      'confirmed',
      'handover',
    ].contains(controllerOrderModel.orderStatus);
    final bool hasValidPayer =
        controllerOrderModel.chargePayer == 'sender' ||
        controllerOrderModel.chargePayer == 'receiver';
    ...
    switch (parcelState) {
      ...
      case ParcelState.readyToConfirm:
        return _buildParcelConfirmationActions(
          context,
          orderController,
      ...
      case ParcelState.readyToPickup:
        return _buildParcelPickupSlider(
          context,
          orderController,
          controllerOrderModel,
          showPaymentInfo,
      ...
      case ParcelState.readyToDeliver:
        return _buildParcelDeliverySlider(
          orderController,
          controllerOrderModel,
        );
        ...
        children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'amount_collect_from_customer'.tr,
                          ...
                          (controllerOrderModel.paymentMethod !=
                                      ...
                                      controllerOrderModel.paymentMethod !=
                                          'offline_payment') &&
                                  controllerOrderModel.paymentStatus == 'paid'
                              ? Text(
                                  'already_paid_digitally'.tr,
                                  style: robotoRegular.copyWith(
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildParcelConfirmButton(
                  orderController,
                  controllerOrderModel,
                ),
              ),
  ...
  Widget _buildParcelConfirmButton(
    OrderController orderController,
    OrderModel order,
  ) {
    return CustomButtonWidget(
  ...
  Widget _buildParcelPickupSlider(
    BuildContext context,
    OrderController orderController,
    OrderModel controllerOrderModel,
    bool showPaymentInfo,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SliderButton(
            action: () =>
                _handleParcelPickup(orderController, controllerOrderModel),
            label: Text(
          ...
          (controllerOrderModel.isGuest! &&
                      controllerOrderModel.orderStatus == 'pending') ||
                  (!controllerOrderModel.isGuest!)
              ? _buildParcelCancelOption(controllerOrderModel)
              : SizedBox(height: 15),
        ],
      ),
    );
  ...
  Widget _buildParcelDeliverySlider(
    OrderController orderController,
    OrderModel controllerOrderModel,
  ) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            height: showDeliveryConfirmImage ? Dimensions.paddingSizeSmall : 0,
          ),

          SliderButton(
            action: () =>
                _handleParcelDelivery(orderController, controllerOrderModel),
            label: Text(
  ...
  Widget _buildParcelReturnOption(OrderModel order) {
    return !(order.parcelCancellation?.beforePickup == 1)
        ? Container(
            padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
            decoration: BoxDecoration(
              color: Theme.of(Get.context!).cardColor,
            ...
            child: order.parcelCancellation?.setReturnDate == 0
                ? CustomButtonWidget(
                    buttonText: 'set_return_date_and_time'.tr,
                    onPressed: () {
                      showCustomBottomSheet(
                        child: ParcelReturnDateTimeBottomSheet(
                          orderId: orderId,
                          canceledDateTime:
                              orderController.orderModel!.canceled!,
                        ),
                      );
                    },
                  )
  ...
  void _handleParcelConfirmation(
    OrderController orderController,
    OrderModel order,
  ) {
    Get.dialog(
  ...
  void _processParcelConfirmation(
    OrderController orderController,
    OrderModel order,
  ) {
  ...
  void _showParcelVerifyDeliverySheet(
    OrderModel order,
    bool verify,
    bool cod,
    bool? isSenderPay,
  ...
  bool _isBeforePickup(OrderModel order) {
    final status = order.orderStatus;
    return status == AppConstants.processing ||
